...
## Year 2024
1. [NIPS 2024] **Model Decides How to Tokenize: Adaptive DNA Sequence Tokenization with MxDNA**[[paper]](https://openreview.net/forum?id=AQ1umQL7dZ&noteId=aDZgF11Qs0)
1. [NIPS 2024] **DART-Eval: A Comprehensive DNA Language Model Evaluation Benchmark on Regulatory DNA**[[paper]](https://nips.cc/virtual/2024/poster/97497)[[code]](https://github.com/kundajelab/DART-Eval)
1. [NIPS 2024] **A SARS-CoV-2 Interaction Dataset and VHH Sequence Corpus for Antibody Language Models**[[paper]](https://nips.cc/virtual/2024/poster/97722)
1. [NIPS 2024] **AsEP: Benchmarking Deep Learning Methods for Antibody-specific Epitope Prediction**[[paper]](https://nips.cc/virtual/2024/poster/97702)
1. [NIPS 2024] **Antigen-Specific Antibody Design via Direct Energy-based Preference Optimization**[[paper]](https://nips.cc/virtual/2024/poster/95910)
1. [NIPS 2024] **Reactzyme: A Benchmark for Enzyme-Reaction Prediction**[[paper]](https://openreview.net/forum?id=xepxnDQoGq#discussion)
1. [NIPS 2024] **CARE: a Benchmark Suite for the Classification and Retrieval of Enzymes**[[paper]](https://openreview.net/forum?id=PFwlw9bnAr#discussion)[[code]](https://github.com/jsunn-y/CARE)
1. [NIPS 2024] **ProSST: Protein Language Modeling with Quantized Structure and Disentangled Attention**[[paper]](https://openreview.net/pdf/6c75eed7fafd81f83f87f954b10f95768b59f37b.pdf)[[code]](https://github.com/ai4protein/ProSST)
1. [NIPS 2024] **MutaPLM: Protein Language Modeling for Mutation Explanation and Engineering**[[paper]](https://openreview.net/forum?id=yppcLFeZgy&referrer=%5Bthe%20profile%20of%20Hao%20Zhou%5D(%2Fprofile%3Fid%3D~Hao_Zhou5))
1. [NIPS 2024] **Protein-Nucleic Acid Complex Modeling with Frame Averaging Transformer**[[paper]](https://openreview.net/forum?id=Xngi3Z3wkN&noteId=KlUBjgQFhT)
1. [NIPS 2024] **Towards Stable Representations for Protein Interface Prediction**[[paper]](https://nips.cc/virtual/2024/poster/95383)
1. [NIPS 2024] **ProtGO: Function-Guided Protein Modeling for Unified Representation Learning**[[paper]](https://nips.cc/virtual/2024/poster/96904)
1. [NIPS 2024] **Generalized Protein Pocket Generation with Prior-Informed Flow Matching**[[paper]](https://openreview.net/forum?id=WyVTj77KEV)
1. [NIPS 2024] **MSAGPT: Neural Prompting Protein Structure Prediction via MSA Generative Pre-Training**[[paper]](https://arxiv.org/abs/2406.05347)[[code]](https://github.com/THUDM/MSAGPT)
1. [NIPS 2024] **Training Compute-Optimal Protein Language Models**[[paper]](https://www.biorxiv.org/content/10.1101/2024.06.06.597716v1)
...
1. [NIPS 2024] **MSA Generation with Seqs2Seqs Pretraining: Advancing Protein Structure Predictions**[[paper]](https://neurips.cc/virtual/2024/poster/96109)[[code]](https://github.com/lezhang7/MSAGen)
1. [NIPS 2024] **FlexSBDD: Structure-Based Drug Design with Flexible Protein Modeling**[[paper]](https://openreview.net/forum?id=4AB54h21qG)
